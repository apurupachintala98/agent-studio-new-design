    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1 overflow-hidden relative">
                {/* Diagonal grid decoration (top-right area) */}
                <div
                    className="absolute top-0 right-96 w-56 h-28 pointer-events-none"
                    style={{
                        backgroundImage:
                            "repeating-linear-gradient(135deg,#cbd5e1 0,#cbd5e1 1px,transparent 1px,transparent 14px)",
                        opacity: 0.35,
                    }}
                />
                ...
                {/* ── SSE Debug Panel ── */}
                <div className="w-96 border border-gray-200 bg-white flex flex-col flex-shrink-0 mx-4 mt-4 mb-6">
                    {/* Panel title */}
                    ...
                    {/* Metrics grid */}
                    <div className="p-5 grid grid-cols-2 gap-y-4 gap-x-6 bg-white">
                        <div>
